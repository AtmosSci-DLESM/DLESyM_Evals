...
PARAMS_Z500_seasonal_cycle_agu_advances2026 = {
    # forecast file 
    ...
    'savefig_params': {
        'fname' : './forecast_seasonal_cycle.png',
        'dpi' : 300,
    },
    'verif_title':'6-year ERA5 Seasonal Cycle',
}
PARAMS_Z500_NH_40yr_blocking_agu_advances2026 = {
...
params_nam_agu_advances2026 = dict(
        input_file = '/home/disk/rhodium/nacc/forecasts/hpx64_coupled-dlwp-olr_seed0+hpx64_coupled-dlom-olr_unet_dil-112_double_restart/atmos_hpx64_coupled-dlwp-olr_seed0+hpx64_coupled-dlom-olr_unet_dil-112_double_restart_100yearJanInit_z1000_ll.nc',
        mode = 'NAM',
        output_cache = './nam-sam/cache_nam_agu_advances2026.nc',
        output_plot_file =  './nam-sam/map_nam_agu_advances2026.png'

    )
params_sam_agu_advances2026 = dict(
        input_file = '/home/disk/rhodium/nacc/forecasts/hpx64_coupled-dlwp-olr_seed0+hpx64_coupled-dlom-olr_unet_dil-112_double_restart/atmos_hpx64_coupled-dlwp-olr_seed0+hpx64_coupled-dlom-olr_unet_dil-112_double_restart_100yearJanInit_z500_ll.nc',
        mode = 'SAM',
        output_cache = './nam-sam/cache_sam_agu_advances2026.nc',
        output_plot_file = './nam-sam/map_sam_agu_advances2026.png'
    )
tc_params_agu_advances2026 = dict(
...
if __name__ == "__main__":
    ...
    if run_seasonal_cycle:
        from seasonal_cycle import main as seasonal_cycle_main
        seasonal_cycle_main(PARAMS_Z500_seasonal_cycle_agu_advances2026)
    if run_blocking:
        from blocking import blocking_frequency
        blocking_frequency(**PARAMS_Z500_NH_40yr_blocking_agu_advances2026)
    if run_tc:
        from TC_freq_hpx import main as tc_main
        tc_main(**tc_params_agu_advances2026)
    if run_nam:
        from NAM_SAM_hpx import main as nam_sam_main
        nam_sam_main(**params_nam_agu_advances2026)
    if run_sam:
        from NAM_SAM_hpx import main as nam_sam_main
        nam_sam_main(**params_sam_agu_advances2026)
